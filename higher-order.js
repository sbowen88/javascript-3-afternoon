...
//Code Here
let totalPopulation  = populations.reduce((total, item) => total + item);
...
//let jocks = athletes.filter((athlete) => athlete.wits < 5)
...
let ordersTotal = orders.filter((price, tax)=>price*(tax+1); //Code Here
ordersTotal
