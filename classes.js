...
class Employee{
 ...
 let chris = new Employee('Chris', 'Johnson', 'chrisjohnson@gmail.com', 25);
 chris 
 let chrisWidget = chris.makeWidget();
 chrisWidget
...
let Mark = new Manager('Mark', 'Williams', 'mw@gmail.com', 40, [])
Mark
let markWidget = Mark.makeWidget();
markWidget
...
class ProgressiveManager{
 ...
 update(){
  ...
  else if (11<=this.reports.length && this.reports.length<=40){
    this.title = 'Manager';
  }
